    ...
    {loading ? (
      ...
      <div>
        <div className="my-4 flex flex-col lg:flex-row h-auto lg:h-[450px] space-y-4 lg:space-y-0 lg:space-x-4">
          ...
          <div className="flex min-w-full lg:min-w-[250px] flex-col rounded-md bg-richblack-800 p-4 sm:p-6">
            <p className="text-lg font-bold text-richblack-5">Statistics</p>
            <div className="mt-4 space-y-4">
              <div>
                <p className="text-base sm:text-lg text-richblack-200">Total Courses</p>
                <p className="text-2xl sm:text-3xl font-semibold text-richblack-50">
                  {courses.length}
                </p>
              </div>
              <div>
                <p className="text-base sm:text-lg text-richblack-200">Total Students</p>
                <p className="text-2xl sm:text-3xl font-semibold text-richblack-50">
                  {totalStudents}
                </p>
              </div>
              <div>
                <p className="text-base sm:text-lg text-richblack-200">Total Income</p>
                <p className="text-2xl sm:text-3xl font-semibold text-richblack-50">
                  Rs. {totalAmount}
                </p>
              </div>
        ...
        <div className="rounded-md bg-richblack-800 p-4 sm:p-6">
          ...
          <div className="my-4 flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-6">
            {courses.slice(0, 3).map((course) => (
              <div key={course._id} className="w-full sm:w-1/3">
                <img
                  src={course.thumbnail}
                  alt={course.courseName}
                  className="aspect-[5/3] w-full rounded-md object-fill"
                />
      ...
      <div className="mt-10 sm:mt-20 rounded-md bg-richblack-800 p-6 py-16 sm:py-20">
