              ...
              {courseContent.map((section) => (
                ...
                >
                  ...
                  <div onClick={() => handleActive(section._id)}>
                    <div className="flex cursor-pointer items-start justify-between bg-opacity-20 px-7  py-6 transition-[1s]">
                  ...
                  <div
                    className={`${
                        isActive.includes(section._id) ? "max-h-screen" : "max-h-0"
                    } relative overflow-hidden bg-richblack-900 transition-[max-height] duration-500 ease-in-out`}
                  >
                    {section.SubSection.map((subSection) => (
                      <div
                        key={subSection._id}
                        className="text-textHead border-b border-richblack-500 flex flex-col gap-2 px-7 py-6 font-semibold"
                      >
